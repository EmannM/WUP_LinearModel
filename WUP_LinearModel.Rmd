...
The model suggests that r-squared is 0.536 and another metric, the residual standard error, is 1.144. This model is better than the previous two, because its residual standard error is smaller and the adjusted r-squared is bigger than both.
...
The p-value, which is 0.000004, is very low. So, that means there is a significant difference between the two models. That difference is 29.45. Model 2, with ARM and GRIP, is better than the model with just ARM.
